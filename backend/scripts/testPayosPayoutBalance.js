...
async function main() {
  ...
  console.log("PAYOS_PAYOUT_CLIENT_ID:", clientId ? clientId.slice(0, 6) + "..." + clientId.slice(-4) : "MISSING");
  console.log("PAYOS_PAYOUT_API_KEY:", apiKey ? apiKey.slice(0, 6) + "..." + apiKey.slice(-4) : "MISSING");
...
main().catch((error) => {
  console.error("Test payout balance error:", error);
});