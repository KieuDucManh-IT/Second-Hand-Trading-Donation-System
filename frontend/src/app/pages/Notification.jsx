...
function NotificationCard({ noti, onRead, onDelete, onNavigate }) {
  ...
  return (
    <div
      ...
      onClick={handleClick}
    >
      <div className={`flex-shrink-0 p-2.5 rounded-full ${color}`}>{icon}</div>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <p
              className={`text-sm mt-0.5 ${noti.isRead ? "font-normal text-gray-700" : "font-semibold text-gray-900"}`}
            >
              {noti.title}
            </p>
