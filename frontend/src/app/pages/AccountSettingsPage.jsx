  ...
  const fetchMyLocations = async () => {
    try {
      ...
      try {
        ...
        throw new Error(
          "Backend không trả về JSON. Kiểm tra lại API get locations.",
        );
      }
  ...
  const handleDeleteLocation = async (locationId) => {
    try {
      ...
      try {
        ...
        throw new Error(
          "Backend không trả về JSON. Kiểm tra lại API delete location.",
        );
      }
  ...
  const handleUpdateLocation = async (e) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error(
          "Backend không trả về JSON. Kiểm tra lại API URL hoặc route backend.",
        );
      }
