<<<<<<< Updated upstream:frontend/src/app/pages/CreateOrderPage.tsx
...
import { Checkbox } from "../components/ui/checkbox";
import { ImageWithFallback } from "../components/figma/ImageWithFallback";
>>>>>>> Stashed changes:frontend/src/app/pages/CreateOrderPage.jsx
import {
  ShieldCheck,
  CreditCard,
  Wallet,
...
function normalizeProduct(raw) {
  ...
  return {
    ...
    thumbnail:
      product.thumbnail || product.productImage || product.image || null,
...
=======
                        <li>
                          1. Buyer đặt đơn và chọn phương thức thanh toán.
                        </li>
                        <li>
                          2. Nếu thanh toán ví, tiền được hệ thống giữ an toàn.
                        </li>
                        <li>3. Seller giao hàng cho buyer.</li>
                        <li>
                          4. Buyer xác nhận nhận hàng, tiền mới chuyển cho
                          seller.
                        </li>
>>>>>>> Stashed changes:frontend/src/app/pages/CreateOrderPage.jsx
                      </ul>
                  ...
                  {phone || address ? (
                    <div className="flex items-center justify-between bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-xl px-4 py-2.5">
                      <div className="flex items-center gap-2 text-sm text-green-700 dark:text-green-400">
                        ...
                        <span>
                          Thông tin được lấy từ hồ sơ của bạn. Bạn có thể chỉnh
                          sựa nếu cần.
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-xl px-4 py-2.5">
                      ...
                      <span className="text-sm text-yellow-700 dark:text-yellow-400">
                        Bạn chưa có đẻa chỉ trong hồ sơ. Vui lòng điền thông tin
                        giao hàng bên dưới.
                      </span>
>>>>>>> Stashed changes:frontend/src/app/pages/CreateOrderPage.jsx
                    </div>
...
=======
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-gray-400">
                      Hoặc nhập địa chỉ khác bên trên
                    </p>
>>>>>>> Stashed changes:frontend/src/app/pages/CreateOrderPage.jsx
                  </div>
                ...
                <div className="bg-white dark:bg-secondary/20 rounded-2xl p-6 mb-6 shadow-sm space-y-4">
                  ...
                  {paymentMethod === "wallet" && (
                    <div className="flex gap-2 p-3 bg-green-50 dark:bg-green-950/30 rounded-xl text-xs text-green-700 dark:text-green-300">
                      ...
                      <p>
                        Tiền sẽ được hệ thống giữ an toàn và chỉ chuyển cho
                        seller sau khi bạn xác nhận đã nhận hàng.
                      </p>
                    </div>
                  )}
                </div>
...
=======
                      Nếu thanh toán qua ví, hệ thống sẽ giữ tiền cho đến khi
