...
export default function WalletPage() {
  ...
  async function syncDepositStatus(orderCode: number, showMessage = false) {
    try {
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <button
            onClick={() => fetchWallet()}
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white"
          >
