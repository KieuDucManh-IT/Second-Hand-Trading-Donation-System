...
<<<<<<< Updated upstream:frontend/src/app/pages/ExchangeHistoryPage.tsx
function formatMoney(value?: number) {
  return new Intl.NumberFormat("vi-VN").format(Number(value || 0)) + "đ";
=======
function formatMoney(value) {
  return new Intl.NumberFormat("vi-VN").format(Number(value || 0)) + " VND";
>>>>>>> Stashed changes:frontend/src/app/pages/ExchangeHistoryPage.jsx
}
...
function getComplaintReason(invoice) {
  return invoice.complaint?.reason || invoice.disputeReason || "";
}

function getComplaintEvidences(invoice) {
  return invoice.complaint?.evidences || [];
}

function isEvidenceVideo(file) {
  return (
    file.type === "video" ||
...
=======
  ...
  const [complaintInvoice, setComplaintInvoice] = useState(null);
...
=======
  function isReceiver(invoice) {
    return getId(invoice.receiver) === currentUserId;
  }

  function getMySide(invoice) {
    return isRequester(invoice) ? "requester" : "receiver";
  }

  async function runAction(invoiceId, action, path, body) {
    try {
  ...
  function openComplaintModal(invoice) {
  ...
  function handleComplaintFilesChange(e) {
...
>>>>>>> Stashed changes:frontend/src/app/pages/ExchangeHistoryPage.jsx
  ...
  function ComplaintEvidenceBlock({ exchange }) {
...
<<<<<<< Updated upstream:frontend/src/app/pages/ExchangeHistoryPage.tsx
=======
    const receiverSide = isReceiver(exchange);
    const myConfirmed = isRequester(exchange)
            ...
            <div className="flex-1 min-w-0">
              ...
              {status === "active" && (
                <div className="mt-4 rounded-lg bg-blue-50 p-3 text-sm text-blue-800">
                  Giao dịch đang diễn ra. Hệ thống đang giữ tiền bảo hiểm của cả
                  hai bên. Khi cả 2 xác nhận hoàn tất hoặc quá 7 ngày không có
                  khiếu nại, tiền sẽ được hoàn lại sau khi trừ phí trung gian.
                </div>
              )}
...
=======
                ...
                {canConfirmCompleted && (
                  ...
                  >
                    {isActionLoading("confirm-completed") ? (
                      <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                    ) : (
                ...
                {canDispute && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => openComplaintModal(exchange)}
                    disabled={!!actionLoading}
          ...
          <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-900">
            <div className="mb-4">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Vui lòng nhập lý do và tải lên ảnh/video làm bằng chứng. Hệ
                thống sẽ tạm dừng hoàn tiền tự động.
              </p>
            </div>
