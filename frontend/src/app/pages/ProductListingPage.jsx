<<<<<<< Updated upstream:frontend/src/app/pages/ProductListingPage.tsx
...
import { Card, CardContent } from "../components/ui/card";
import { Badge } from "../components/ui/badge";
>>>>>>> Stashed changes:frontend/src/app/pages/ProductListingPage.jsx
import {
  Select,
  SelectContent,
  SelectItem,
...
>>>>>>> Stashed changes:frontend/src/app/pages/ProductListingPage.jsx
      <div className="flex items-center space-x-2">
        <Checkbox
          ...
          onCheckedChange={(v) => {
            setShowDonationsOnly(!!v);
            setPage(1);
          }}
        />

        <Label htmlFor="donations-only" className="cursor-pointer">
          Chỉ hiện đồ tặng miễn phí
        </Label>
      </div>
              ...
              <>
                ...
                >
                  {products.map((product) => (
                    ...
                    >
                      <div
                        className={`relative ${viewMode === "list" ? "w-40 shrink-0 h-full" : "h-52"}`}
                      >
                        <ImageWithFallback
                          src={
                            product.thumbnail ||
