<<<<<<< Updated upstream:frontend/src/app/pages/CreateProductPage.tsx
...
>>>>>>> Stashed changes:frontend/src/app/pages/CreateProductPage.jsx
...
=======
  ...
  const checkSensitiveDynamic = (text) => {
    if (!text) return null;
    const lower = text.toLowerCase();
    return (
      forbiddenKeywords.find((w) => lower.includes(w.toLowerCase())) || null
    );
  };
  const validate = () => {
    const newErrors = {};
...
=======
      ...
      if (bad)
        newErrors.description = `Mô tả chứa từ không được phép: "${bad}"`;
>>>>>>> Stashed changes:frontend/src/app/pages/CreateProductPage.jsx
    }
    ...
    try {
      ...
      if (!productRes.ok) {
        ...
        if (productData.field) {
          setErrors((prev) => ({
            ...prev,
            [productData.field]: productData.message,
          }));
        } else {
      ...
      if (!imgRes.ok) {
        ...
        toast.warning(
          `Sản phẩm đã tạo nhưng upload ảnh lỗi: ${imgData.message}`,
        );
      }
      setSubmitted(true);
    } catch (err) {
...
=======
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm">
              Sản phẩm của bạn đã được <strong>đăng công khai</strong> và mọi
              người có thể xem ngay bây giờ.
>>>>>>> Stashed changes:frontend/src/app/pages/CreateProductPage.jsx
            </p>
...
=======
            <p className="text-sm text-red-600 dark:text-red-400 flex items-center gap-1 mt-1">
              ...
              Người đăng tự chịu trách nhiệm về toàn bộ thông tin và nội dung
              của sản phẩm đã đăng
>>>>>>> Stashed changes:frontend/src/app/pages/CreateProductPage.jsx
            </p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    <SelectTrigger
                      className={`mt-2 ${errors.categoryId ? "border-red-500" : ""}`}
                    >
                      <SelectValue
                        placeholder={
                ...
                <div>
                  ...
                  >
                    <SelectTrigger
                      className={`mt-2 ${errors.condition ? "border-red-500" : ""}`}
                    >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <Label>
                    Loại đăng <span className="text-red-500">*</span>
                  </Label>
                  <Select
                    value={formData.type}
                    onValueChange={(v) =>
                      setFormData({
                        ...formData,
                        type: v,
                        price: v === "donate" ? "0" : formData.price,
                      })
                    }
                  >
