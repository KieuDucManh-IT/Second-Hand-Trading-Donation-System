<<<<<<< Updated upstream:frontend/src/app/pages/ExchangeRequestsPage.tsx
import { useEffect, useMemo, useState, type ChangeEvent } from "react";
=======
import { useEffect, useMemo, useState } from "react";
import { useNavigate } from "react-router-dom";
>>>>>>> Stashed changes:frontend/src/app/pages/ExchangeRequestsPage.jsx
...
=======
function getShortProductTitle(product, maxLength = 28) {
...
>>>>>>> Stashed changes:frontend/src/app/pages/ExchangeRequestsPage.jsx
  ...
  function ExchangeInvoiceCard({ invoice }) {
    ...
    const isLoading = (action) => actionLoading === `${invoiceId}-${action}`;
...
>>>>>>> Stashed changes:frontend/src/app/pages/ExchangeRequestsPage.jsx
  ...
  function InvoiceList({ list, emptyTitle, emptyDescription }) {
    if (loading) {
      return (
        <Card>
          <CardContent className="p-12 text-center">
