<<<<<<< Updated upstream:frontend/src/app/components/manager-dashboard/Header.tsx
...
export function Header({ setActiveTab, repairExchangeProducts }) {
...
>>>>>>> Stashed changes:frontend/src/app/components/manager-dashboard/Header.jsx
  return (
